...
public class GameControl {
    ...
    private void help() {
        ...
        System.out.println("items/inv/inventory: shows you what items you have in your bag.");
    ...
    public void createMap() {
        Monster goblin = new Monster("mine goblin", 15, 4, null);
        ...
        r2.setRoomMonster(new Monster("black rat", 15, 2, (new Armor("fur hat", 2))));
        ...
        r4.setRoomMonster(new Monster("zombie dwarf", 18, 3, (new Potion("rotten meat", 10))));
        ...
        r10.setRoomMonster(new Monster("skeleton warrior", 20, 5, (new Weapon("Steel sword", 10))));
        ...
        r14.setRoomMonster(new Monster("Fire Elemental", 40, 15, (new Armor("Ironclad boots", 15))));
